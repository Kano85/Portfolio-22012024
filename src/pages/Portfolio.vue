    ...
    >
      ...
      >
        <div class="relative font-medium">
          ...
          >
            <span>
              <span class="[text-decoration:underline]">Linkedln</span>
            </span>
          </a>
          <span> | </span>
          <a
          ...
          >
            <span>
              <span class="[text-decoration:underline]">Xing</span>
            </span>
          </a>
          <span> | </span>
...
<script lang="ts">
  ...
  export default defineComponent({
    name: "Portfolio",
    components: { Header, MyRecentWork, Contact },
    methods: {
      onGroupClick() {
